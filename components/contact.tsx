...
//   const socialLinks = [
//     { icon: <Github className="h-5 w-5" />, href: "https://github.com/Paritybitz", label: "GitHub" },
//     { icon: <Linkedin className="h-5 w-5" />, href: "https://linkedin.com/in/alimohsin05", label: "LinkedIn" },
//   ]
